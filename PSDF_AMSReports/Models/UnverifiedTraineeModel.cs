...
namespace PSDF_AMSReports.Models
{
    ...
    public class Table1
    {
        ...
        public string ClassVistDate { get; set; }
        public int? TotalNumberOfRegisteredTrainees { get; set; }
        public int? TotalTraineesPresentInClass { get; set; }
    }
    public class Table2
    {
