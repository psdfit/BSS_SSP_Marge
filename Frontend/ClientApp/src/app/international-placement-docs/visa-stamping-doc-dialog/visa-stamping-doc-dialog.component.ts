...
@Component({
  selector: "app-visa-stamping-doc-dialog",
  templateUrl: "./visa-stamping-doc-dialog.component.html",
  styleUrls: ["./visa-stamping-doc-dialog.component.scss"],
})
export class VisaStampingDocDialogComponent implements OnInit {
  currentUser: any = {}
  ...
  private readonly UPLOAD_URL = "api/IPDocsVerification/UploadVisaStampingDocs"; // Replace with actual URL
  private readonly FETCH_DOCS_URL = "api/IPDocsVerification/GetVisaStampingDocs/"; // URL to fetch documents

  constructor(
    private fb: FormBuilder,
    private dialogRef: MatDialogRef<VisaStampingDocDialogComponent>,
  ...
  ngOnInit(): void {
    ...
    this.setUploadRestrictions(this.data.VisaStampingStauts);
