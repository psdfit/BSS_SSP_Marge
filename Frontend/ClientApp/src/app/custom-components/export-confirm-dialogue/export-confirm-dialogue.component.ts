...
export class ExportConfirmDialogueComponent implements OnInit {
  ...
  async generateExcel() {
    ...
    if (
      ...
      || this.input.Type === EnumExcelReportType.PVRN 
      || this.input.Type === EnumExcelReportType.MRN 
      || this.input.Type === EnumExcelReportType.PCRN 
    ) {
    ...
    dataForExport.forEach((item, index) => {
      ...
      if (this.input.Type === EnumExcelReportType.VisitPlan
        ...
        || this.input.Type === EnumExcelReportType.MRN
        || this.input.Type === EnumExcelReportType.PCRN
        || this.input.Type === EnumExcelReportType.OTRN
