...
export class ExportConfirmDialogueComponent implements OnInit {
  ...
  async generateExcel() {
    ...
    if (this.input.Type === EnumExcelReportType.MPR || this.input.Type === EnumExcelReportType.SRN  || this.input.Type === EnumExcelReportType.TPRN || this.input.Type === EnumExcelReportType.GURN) {
