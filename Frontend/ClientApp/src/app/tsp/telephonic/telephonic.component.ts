...
@Component({
  ...
  styleUrls: ['./telephonic.component.scss'],
...
export class TelephonicComponent implements OnInit {
  ...
  GetTSPs() {
    this.http.getJSON(`api/TSPEmployment/GetTspForEmploymentVerification?placementTypeId=${this.filters.PlacementTypeID}&verificationMethodId=${this.filters.VerificationMethodID}`).subscribe(
      (d: any) => {
  ...
  GetEmploymentClassesByTSP() {
    this.http.getJSON(`api/TSPEmployment/GetTelephonicEmploymentVerificationClasses?pId=${this.filters.PlacementTypeID}&vmId=${this.filters.VerificationMethodID}&tspId=${this.filters.TSPID}`).subscribe(
      (d: any) => {
 ...
 /*  GetClasses() {
  ...
  GetTelephonicEmploymentClassesList() {
    this.http.getJSON(`api/TSPEmployment/GetTelephonicEmploymentVerificationClasses?pId=${this.filters.PlacementTypeID}&vmId=${this.filters.VerificationMethodID}&tspId=${this.filters.TSPID}&cId=${this.filters.ClassID}`).subscribe(
      (d: any) => {
        this.ClassListFiltered = d.ClassList;
  ...
  GetTraineeOfClass(ClassID: any, r: any) {
    ...
    this.http.getJSON(`api/TSPEmployment/GetTelephonicTraineesForEmploymentVerification?pId=${this.filters.PlacementTypeID}&vmId=${this.filters.VerificationMethodID}&cId=${ClassID}`).subscribe(
      (d: any) => {
  ...
  openDialog(item): void {
    const dialogRef = this.dialog.open(TelephonicEmploymentverification, {
      minWidth: '1000px',
      minHeight: '600px',
  ...
  exportToExcelTraineesData() {
    this.http.getJSON(`api/TSPEmployment/TraineeForVerificationExportExcel?pId=${this.filters.PlacementTypeID}&vmId=${this.filters.VerificationMethodID}&cId=${this.filters.ClassID}`).subscribe(
      (d: any) => {
...
debugger;
    ...
    this.http.getJSON(`api/TSPEmployment/GetTelephonicEmploymentList?pId=${this.filters.PlacementTypeID}&vmId=${this.filters.VerificationMethodID}&cId=${item}&TSPID=${TSPID}`).subscribe(
      (d: any) => {
...
debugger;
    const dialogRef = this.dialog.open(telephonicemploymentverificationComponent, {
      minWidth: '1000px',
      minHeight: '600px',
      //data: JSON.parse(JSON.stringify(row))
      data: item
