...
//};
@Component({
  selector: 'app-telephonic-employment-verification-dialog',
  templateUrl: './telephonic-employment-verification-dialog.component.html',
  styleUrls: ['./telephonic-employment-verification-dialog.component.scss']
})
export class telephonicemploymentverificationComponent implements OnInit {
  ExcelFileForm: any;
  ...
  constructor(private fb: FormBuilder,
    private el: ElementRef, private ComSrv: CommonSrvService, private dialogRef: MatDialogRef<telephonicemploymentverificationComponent>, public domSanitizer: DomSanitizer,
  ...
  Submit(nform: FormGroupDirective) {
    ...
    this.ComSrv.postJSON('api/EmploymentVerification/TelephonicSaveBulk', this.Detail.getRawValue())// { 'json': JSON.stringify(dataObj) })
      .subscribe((d: any) => {
        nform.resetForm();
