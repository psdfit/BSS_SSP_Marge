...
//};
@Component({
  selector: 'app-deo-ojt-employment-verification-dialog',
  templateUrl: './deo-ojt-employment-verification-dialog.component.html',
  styleUrls: ['./deo-ojt-employment-verification-dialog.component.scss']
})
export class DEOOJTEmploymentVerificationDialogComponent implements OnInit {
  ExcelFileForm: any;
  ...
  constructor(private fb: FormBuilder,
    private el: ElementRef, private ComSrv: CommonSrvService, private dialogRef: MatDialogRef<DEOOJTEmploymentVerificationDialogComponent>, public domSanitizer: DomSanitizer,
  ...
  Submit(nform: FormGroupDirective) {
    console.log('tttt')
    console.log('Form Valid:', this.traineeEmploymentForm.valid);
  console.log('Form Errors:', this.traineeEmploymentForm.errors);
  console.log('Form Value:', this.traineeEmploymentForm.getRawValue());
    if (this.traineeEmploymentForm.invalid) {
      this.scrollToFirstInvalidControl();
      return;
    }
    this.ComSrv.postJSON('api/EmploymentVerification/SaveBulkOJT', this.Detail.getRawValue())// { 'json': JSON.stringify(dataObj) })
      .subscribe((d: any) => {
        nform.resetForm();
