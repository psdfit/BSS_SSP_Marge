...
@Component({
  selector: 'hrapp-employment-verification',
  templateUrl: './employment-verification.component.html',
  styleUrls: ['./employment-verification.component.scss']
})
...
export class EmpVerificationComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, public domSanitizer: DomSanitizer, private ComSrv: CommonSrvService, private route: ActivatedRoute,
    public dialogRef: MatDialogRef<EmpVerificationComponent>,
  ...
  Submit(myform: FormGroupDirective) {
    ...
    this.working = true;
    this.ComSrv.postJSON('api/EmploymentVerification/Save', this.EmploymentVerificationForm.value)
      .subscribe((d: any) => {
