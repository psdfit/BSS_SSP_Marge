...
@Component({
  selector: 'hrapp-TelephonicEmployment-verification',
  templateUrl: './TelephonicEmployment-verification.component.html',
  styleUrls: ['./TelephonicEmployment-verification.component.scss']
})

export class TelephonicEmploymentverification implements OnInit {
  ...
  constructor(private fb: FormBuilder, public domSanitizer: DomSanitizer, private ComSrv: CommonSrvService, private route: ActivatedRoute,
    public dialogRef: MatDialogRef<TelephonicEmploymentverification>,
  ...
  getData() {
    this.ComSrv.postJSON('api/TSPEmployment/GetEmploymentDataForVerification', { "ClassID": this.data.ClassID, "TraineeID": this.data.TraineeID }).subscribe((d: any) => {
...
debugger;
    ...
    this.working = true;
    this.ComSrv.postJSON('api/EmploymentVerification/UpdateTelephonicEmploymentVerification', this.EmploymentVerificationForm.value)
      .subscribe((d: any) => {
