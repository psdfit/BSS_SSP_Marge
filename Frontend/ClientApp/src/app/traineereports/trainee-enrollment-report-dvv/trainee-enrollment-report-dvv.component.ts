...
@Component({
  selector: 'app-trainee-enrollment-report-dvv',
  templateUrl: './trainee-enrollment-report-dvv.component.html',
  styleUrls: ['./trainee-enrollment-report-dvv.component.scss'],
  providers: [GroupByPipe, DatePipe]
})
export class TraineeEnrollmentReportDVVComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns = ['TraineeCode', 'TraineeName', 'TraineeCNIC', 'FatherName', 'SchemeName', 'ClassCode', 'IsEnrolled'];
  schemeArray = [];
  tspDetailArray = [];
  classesArray: any[];
  ...
  getPagedData(pagingModel, filterModel) {
    return this.commonService.postJSON('api/TSRLiveData/RD_TERPaged', { pagingModel, filterModel });
  }
