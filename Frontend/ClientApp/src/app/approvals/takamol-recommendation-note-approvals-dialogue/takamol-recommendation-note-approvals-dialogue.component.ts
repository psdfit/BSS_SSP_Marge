...
@Component({
  selector: 'app-takamol-recommendation-note-approvals-dialogue',
  templateUrl: './takamol-recommendation-note-approvals-dialogue.component.html',
  styleUrls: ['./takamol-recommendation-note-approvals-dialogue.component.scss']
})
export class TakamolRecommendationNoteApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TakamolRecommendationNoteApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SaveTakamolRecommendationNoteApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
