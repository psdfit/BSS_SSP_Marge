...
@Component({
  selector: 'app-mrn-approvals-dialogue',
  templateUrl: './mrn-approvals-dialogue.component.html',
  styleUrls: ['./mrn-approvals-dialogue.component.scss']
})
export class MrnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MrnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SaveMRNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
