...
@Component({
  selector: 'app-otrn-approvals-dialogue',
  templateUrl: './otrn-approvals-dialogue.component.html',
  styleUrls: ['./otrn-approvals-dialogue.component.scss']
})
export class OtrnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OtrnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SaveOTRNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
