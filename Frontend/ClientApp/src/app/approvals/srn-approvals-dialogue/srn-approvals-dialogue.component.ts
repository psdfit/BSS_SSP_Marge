...
@Component({
  selector: 'app-srn-approvals-dialogue',
  templateUrl: './srn-approvals-dialogue.component.html',
  styleUrls: ['./srn-approvals-dialogue.component.scss']
})
export class SrnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SrnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SaveSRNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
