...
@Component({
  selector: 'app-gurn-approvals-dialogue',
  templateUrl: './gurn-approvals-dialogue.component.html',
  styleUrls: ['./gurn-approvals-dialogue.component.scss']
})
export class GurnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<GurnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SaveGURNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
