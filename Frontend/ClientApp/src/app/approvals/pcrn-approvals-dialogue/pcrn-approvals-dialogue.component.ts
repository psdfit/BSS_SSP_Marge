...
@Component({
  selector: 'app-pcrn-approvals-dialogue',
  templateUrl: './pcrn-approvals-dialogue.component.html',
  styleUrls: ['./pcrn-approvals-dialogue.component.scss']
})
export class PcrnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PcrnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SavePCRNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
