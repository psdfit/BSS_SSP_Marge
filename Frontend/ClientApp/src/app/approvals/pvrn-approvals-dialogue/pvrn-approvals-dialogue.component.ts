...
@Component({
  selector: 'app-pvrn-approvals-dialogue',
  templateUrl: './pvrn-approvals-dialogue.component.html',
  styleUrls: ['./pvrn-approvals-dialogue.component.scss']
})
export class PvrnApprovalsDialogueComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PvrnApprovalsDialogueComponent>,
  ...
  save(approvalStatusID: number) {
    ...
    if (this.approvalForm.valid) {
      ...
      this.http.postJSON("api/Approval/SavePVRNApprovalHistory", obj).subscribe(
        (_response: any) => {
          if (_response == true) {
