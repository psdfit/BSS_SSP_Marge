...
namespace DataLayer.Interfaces
{
    ...
    public interface ISRVTSPMaster
    {
        ...
        public string GET_KAMAndTspUserByTakamolRecommendationNoteIDs_Notification(string PCRNIDs, SqlTransaction transaction = null);
        ...
        public ApprovalHistoryModel GET_ConcateClassescodebyTakamolRecommendationNoteID_Notification(string PCRNIDs, SqlTransaction transaction = null);
